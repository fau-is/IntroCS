...
def example():
    """Example from PSet"""
    check50.run("python3 bin_tree_check.py 1,2,3,4,5,6,7,8").stdout("preorder: 1, 2, 3, 4, 5, 6, 7, 8, inorder: 1, 2, 3, 4, 5, 6, 7, 8, postorder: 8, 7, 6, 5, 4, 3, 2, 1, find 5: 5preorder: 3, inorder: 3, postorder: 3, find 5: None", regex=False).exit(0)
...
def big_tree():
    """Add a lot"""
    check50.run("python3 bin_tree_check.py 3,4,6,2,1,9,9,4,65,91,4,1,0,34,67,2,5").stdout("preorder: 3, 2, 1, 0, 4, 6, 5, 9, 65, 34, 91, 67, inorder: 0, 1, 2, 3, 4, 5, 6, 9, 34, 65, 67, 91, postorder: 0, 1, 2, 5, 34, 67, 91, 65, 9, 6, 4, 3, find 5: 5preorder: 3, inorder: 3, postorder: 3, find 5: None", regex=False).exit(0)
