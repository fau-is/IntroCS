...
Problem 3: Implement a Function to get plain Text
...
Hint: You can use the Beautiful Soup library.
Problem 4: Write a Function which loads Toots from Mastodon
...
•	Hint: For this task it is very helpful to check the mastodon documentation about the returning dictionaries, especially media dicts.
